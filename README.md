# Project ServicioSocial

## Features

- [x] Login authentification with Gmail
- [x] Secured API endpoints with token
- [x] Documented API with [Swagger](http://localhost:3000/api-docs/)
